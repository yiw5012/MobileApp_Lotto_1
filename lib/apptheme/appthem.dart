...
abstract final class AppTheme {
  ...
  static ThemeData light = FlexThemeData.light(
    ...
    subThemesData: const FlexSubThemesData(
      ...
      snackBarBackgroundSchemeColor: SchemeColor.secondaryFixed,
      snackBarActionSchemeColor: SchemeColor.error,
      drawerRadius: 7.0,
      drawerBackgroundSchemeColor: SchemeColor.primaryFixed,
